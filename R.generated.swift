...
struct _R {
  ...
  struct image {
    ...
    /// Image `background_DS_2`.
    var background_DS_2: RswiftResources.ImageResource { .init(name: "background_DS_2", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
    ...
    /// Image `icon_back_settings`.
    var icon_back_settings: RswiftResources.ImageResource { .init(name: "icon_back_settings", path: [], bundle: bundle, locale: nil, onDemandResourceTags: nil) }
