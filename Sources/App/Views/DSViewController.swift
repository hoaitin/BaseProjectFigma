...
class DSViewController: UIViewController{
    ...
    func setUpViews() {
        ...
        let gradient = UiltFormat.share.gradientImage(bounds: CGRect(x: 0, y: 0, width: view.frame.width - 60, height: 60), colors: [UIColor(hex: 0xC048FF), UIColor(hex: 0x4ABEFE)])
